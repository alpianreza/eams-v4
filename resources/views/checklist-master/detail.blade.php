...
<div class="checklist-master-page">
    ...
    <section class="row g-2 mb-3 checklist-master-stats">
        <div class="col-6 col-lg-3">
            <div class="card checklist-master-stat-card">
                <div class="card-body">
                    <div class="checklist-master-stat-label">Total Pertanyaan</div>
                    <div class="checklist-master-stat-value">{{ $totalQuestions }}</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="card checklist-master-stat-card">
                <div class="card-body">
                    ...
                    <div class="checklist-master-stat-value">{{ $activeQuestions }}</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="card checklist-master-stat-card">
                <div class="card-body">
                    ...
                    <div class="checklist-master-stat-value">{{ $photoRequiredQuestions }}</div>
                </div>
            </div>
        </div>
        <div class="col-6 col-lg-3">
            <div class="card checklist-master-stat-card">
                <div class="card-body">
                    ...
                    @else
                    <div class="checklist-master-stat-value">{{ $frequencyLabel }}</div>
                    @endcan
                </div>
            </div>
        </div>
    ...
    <section class="card checklist-master-table-card">
